...
const Navigation = () => {
  ...
  // Debug: Affiche l'état de connexion dans la console
  console.log('État de connexion:', user ? 'Connecté' : 'Non connecté');
        ...
        {user && (
          <div className="pt-4 pb-3 border-t border-green-700">
            <div className="flex items-center px-5">
              ...
              <div className="ml-3">
                <div className="text-base font-medium text-white">{user.nom || 'Utilisateur'}</div>
